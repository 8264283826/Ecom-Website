...
if(isset($_POST['submit'])){
	...
	$insert_p_cat = "INSERT INTO  product_categorys (p_cat_title,p_cat_desc) VALUES ('$p_cat_title','$p_cat_desc')";
	$run_p_cat = mysqli_query($con,$insert_p_cat)or die('query fail:insert');
